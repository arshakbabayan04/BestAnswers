                                ...
                                <div className="w-full mb-2 border border-gray-200 rounded-lg bg-gray-50 ">
                                    <div className="px-4 py-2 border-b-2 bg-white rounded-t-lg">
                                        ...
                                        <Field
                                            ...
                                            type="text"
                                            id="email"
                                            className="block focus:outline-none flex-1 w-full bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    ...
                                    <div className="px-4 py-2 bg-white rounded-t-lg">
                                        ...
                                        <Field
                                            ...
                                            as="textarea"
                                            id="text"
                                            className="w-full focus:outline-none px-0 text-sm border-0 text-gray-900 bg-white border-0s"
